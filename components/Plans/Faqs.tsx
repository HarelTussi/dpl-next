...
const Faq = ({ question, answer }: { question: string; answer: string }) => {
  ...
  return (
    <div
      className={clsx(
        "mb-2 w-full border  border-primary2-50 px-4 py-3 transition-all ease-in-out",
    ...
    >
      ...
      >
        <p className="text-gray-500 mt-4 text-sm leading-5 text-primary2-200">
          {answer}
        </p>
      </motion.div>
    </div>
